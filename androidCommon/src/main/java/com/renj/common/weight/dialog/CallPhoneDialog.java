...
public class CallPhoneDialog extends Dialog implements View.OnClickListener {
    ...
    private String phoneNumber = "",
            ...
            okText = ResUtils.getString(R.string.common_call);
    private int phoneColor = ResUtils.getColor(R.color.common_main_text),
            cancelColor = ResUtils.getColor(R.color.common_dialog_bt_text),
            okColor = ResUtils.getColor(R.color.common_dialog_bt_text);
    ...
    // 默认宽和高
    private int width = UIUtils.dip2px(280);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.common_dialog_call_phone);
