...
public class WrongDiaView extends View {
    ...
    private void drawDynamic(Canvas canvas) {
        ...
        if (progress == 100) {
            ...
            //画第一根线
            canvas.drawLine(mMin, mMin,
                    mMin + line1_x, mMin + line1_x, mPaint);
            ...
            if (line1_x > mDx) {
                ...
                //画第二根线
                canvas.drawLine(mMax, mMin,
                        mMax - line2_x, mMin + line2_x, mPaint);
    ...
    private void drawStatic(Canvas canvas) {
        ...
        canvas.drawLine(mMin, mMin, mMax, mMax, mPaint);
        canvas.drawLine(mMax, mMin, mMin, mMax, mPaint);
    }
