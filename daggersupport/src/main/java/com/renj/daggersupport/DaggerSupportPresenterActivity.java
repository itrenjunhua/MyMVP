 ...
 * ======================================================================
 */
public abstract class DaggerSupportPresenterActivity<T extends BasePresenter> extends RxBasePresenterActivity<T> implements HasFragmentInjector, HasSupportFragmentInjector {
    @Inject
